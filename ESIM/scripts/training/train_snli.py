...
from esim.model import ESIM, ABCNN
...
def main(train_file,
    ...
    # Choose ABCNN variant and conv params
    # abcnn_type = "ABCNN3"     # "ABCNN1" | "ABCNN2" | "ABCNN3"
    # num_filters = hidden_size # keep parity with ESIM hidden size
    # kernel_size = 3

    # model = ABCNN(vocab_size=embeddings.shape[0],
    #             embedding_dim=embeddings.shape[1],
    #             num_filters=num_filters,
    #             kernel_size=kernel_size,
    #             abcnn_type=abcnn_type,
    #             embeddings=embeddings,
    #             dropout=dropout,
    #             num_classes=num_classes,
    #             device=device).to(device)
...
if __name__ == "__main__":
    default_config = "../../config/training/train_cmdw.json"
